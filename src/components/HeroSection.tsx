  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {/* Left Column: Olivia Jade Giannulli (Hero) */}
        <div 
        ...
        >
          ...
          {/* Overlapping Floating White Card */}
          <div 
            id="hero-primary-card"
            className="absolute bottom-0 left-0 bg-white p-6 sm:p-8 max-w-[90%] sm:max-w-[480px] border-t border-r border-gray-100/80 shadow-md transition-all duration-300 group-hover:-translate-y-1 group-hover:shadow-lg"
          >
        ...
        {/* Right Column: Dermatologist's Routine (Secondary Hero) */}
        <div 
        ...
        >
          ...
          <div className="overflow-hidden aspect-[4/3] w-full shadow-sm bg-neutral-100 relative">
            <img
              ...
              src={secondaryHeroArticle.images[0]}
